...
You can easily customize your dashboard manually adding the widgets and linking your variables to them. As a reference take a look at the https://github.com/dbduino-prjs/spkfn-weather-station-arduino-cloud/blob/master/assets/Sparkfun_Weather_Station-screenshot1.png?raw=true[screenshot] in the assets folder.
